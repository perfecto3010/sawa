const allGames = {
    ...
    boss_dos: {
        id: "boss_dos",
        title: "بوس أو دوس 💋",
        rules: "بالدور: مرة الزوج يسحب ومرة الزوجة. اللي يجمع 6 كروت بوس يبدلهم بكارت 'دوس' (تحدي قوي). الكروت المتبادلة بتخرج برا اللعبة.",
        color: "#6a1b9a",
        accent: "#9c27b0",
        hasScore: false, // بنستخدم نظام الـ Boss count مش الـ Score العادي
        questions: [
            "بوسة رقيقة على الرقبة 💋",
            "بوسة على الجبين تعبر عن التقدير 💋",
            "بوسة على كل عين برقة 💋",
            "بوسة فرنسية (Deep Kiss) لمدة 10 ثواني 💋",
            "بوسة على كف الإيد بكل حب 💋",
            "بوسة سريعة ومفاجئة على الشفايف 💋",
            "بوسة ورا الودن مع همسة حلوة 💋",
            "بوسة على الكتف 💋"
        ],
        dosQuestions: [
            "تحدي دوس: تنفيذ طلب للطرف الآخر فوراً بدون اعتراض 🔥",
            "تحدي دوس: رقصة سلو لمدة دقيقة على اختيار الطرف التاني 🔥",
            "تحدي دوس: مساج للظهر لمدة 5 دقائق 🔥",
            "تحدي دوس: ممنوع تمسك الموبايل لحد أخر السهرة 🔥"
        ]
    },
    deepTalk: {
        id: "deepTalk",
