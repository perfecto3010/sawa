const allGames = {
    lehalibo: {
        ...
        color: "#ff85a2",
        accent: "linear-gradient(135deg, #d00000, #ff0000)",
        timerDuration: 120,
    ...
    boss_dos: {
        ...
        color: "#6a1b9a",
        accent: "linear-gradient(135deg, #5a189a, #9d4edd)",
...
questions: [
    ...
    accent: "linear-gradient(135deg, #ff0054, #ff5400)", // لون الكروت (فوشيا)
...
heat_meter: {
    ...
    color: "#4a0404",
    accent: "linear-gradient(135deg, #240046, #3c096c)",
    hasScore: false,
    isMultiLevel: true, 
    levels: {
        level1: [
            ...
            "لو ليك 'سلطة كاملة' عليا لمدة ساعة في السرير، إيه أول حاجة هتطلبها؟",
        ...
        level3: [
            ...
            "الطرف التاني يكون 'مسيطر' تماماً لمدة دقيقتين.. يعمل اللي هو عايزه.",
    ...
    color: "#2d005d",
    accent: "linear-gradient(135deg, #ff8c00, #ff0000)",
    hasScore: false,
    questions: [
        "وضع الفارسة: الزوجة فوق الزوج ووشها في وشه، هي اللي بتتحكم في السرعة والعمق بالكامل.",
        "وضع المعلقة (Spooning): ناموا على جنبكم في نفس الاتجاه، والزوج يدخل من ورا.. حميمية وهدوء.",
        "وضع الـ 69: تبادل المتعة بالفم في نفس الوقت، قمة التركيز في إسعاد الطرف التاني.",
        "وضع الفراشة: الزوجة على حافة السرير ورافعة رجلها على كتف الزوج وهو واقف.. عمق جبار.",
        "وضع القطة: الزوجة على بطنها تماماً والزوج فوقها، بيسمح بتلامس الجسم كله وقبلات الرقبة.",
        "وضع السيطرة الخلفية (Doggy Style): الزوجة على إيدها ورجلها والزوج من الخلف.. إثارة كلاسيكية.",
        "وضع المقص: الزوجين نايمين على جنبهم وداخلين في بعض زي المقص.. بطيء ومثير.",
        "وضع العناق: الزوج جالس والزوجة فوقه ولفه رجلها حول وسطه.. حضن وبوس وتواصل بصري.",
        "الوضع التقليدي (المبشر): الزوجة على ضهرها والزوج فوقها، مع وضع مخدة تحت وسطها لمتعة أكتر.",
        "وضع الوقوف: الزوج شايل الزوجة وساندها على الحيطة.. جنان وقوة.",
        "وضع الكرسي: الزوج جالس على كرسي والزوجة فوقه بضهرها.. تغيير للمكان والروتين.",
        "وضع السجود المتطور: الزوجة في وضع السجود والزوج يدخل من الخلف ببطء مع مساج للضهر.",
        "وضعية الجسر: الزوجة سانده على كوعها ورافعة وسطها والزوج فوقها.. بتوصل لأماكن جديدة.",
        "وضع الفارسة المقلوبة: الزوجة فوق بس بضهرها للزوج.. إثارة بصرية قوية للزوج.",
        "وضع حرف الـ X: الزوجين نايمين عكس بعض ومتقاطعين.. تلامس مختلف تماماً.",
        "وضعية الغابة: الزوجة ترفع رجل واحدة فقط على كتف الزوج وهو بين رجليها.",
        "الوضع الجانبي المفتوح: الزوجة على جنبها وترفع رجلها اللي فوق والزوج يدخل من الأمام.",
        "وضع المواجهة الأرضية: على السجادة، الزوج جالس والزوجة فوقه في حضنه تماماً.",
        "وضع الأكروبات: الزوجة على ضهرها وبترفع رجلها للسما والزوج بيتحكم من فوق.",
        "وضع التزحلق: الزوجة نايمة على بطنها والزوج بيدخل من الخلف بس وهو مفرود فوقها تماماً.",
        "وضع اللوتس: الزوج يتربع والزوجة تقعد في حضنه وتلف رجلها وراه.. قمة القرب.",
        "وضع الحافة: الزوجة نايمة بالعرض على السرير ورجلها على الأرض والزوج واقف.",
        "وضع الاندماج: الزوجين واقفين ووشهم لبعض، والزوجة ترفع رجل واحدة حول خصر الزوج.",
        "وضع المساج المثير: الزوجة على بطنها، الزوج يعمل مساج ويدخل ببطء من الخلف.",
        "وضع المفاجأة: الزوج يختار وضع غريب ملمستوش قبل كدة أو يدمج وضعين سوا!"
    ]
}
};
