...
heat_meter: {
    ...
    hasScore: false,
    questions: [
        // === قسم "قلب زمان" (25 سؤال رومانسي عن الذكريات) ===
    "إيه أول لحظة حسيت فيها إن قلبك دق ليا بشكل مختلف عن أي حد؟",
    "لو وصفت شعورك أول مرة مسكت إيدي فيها، هتقول إيه؟",
    "إيه أكتر حاجة كنت بتفتقدها فيا وأنت لوحدك في الغربة؟",
    "تفتكر إيه هي 'الأكلة' اللي ريحتها بتفكرك ببيتنا ودفانا؟",
    "إيه هو أكتر موقف عملته معاك وحسيت فيه إني 'سندك' بجد؟",
    "لو رجعنا لأول مقابلة، إيه الكلمة اللي كنت خايف تقولها وقتها ونفسك تقولها دلوقتي؟",
    "إيه أكتر تعبير بيبان على وشي بيخليك تعرف إني محتاجة حضنك من غير ما أتكلم؟",
    "فاكر أول حلم حلمته بيا؟ كان عبارة عن إيه؟",
    "إيه هي أكتر رسالة صوتية (Voice Note) بعتهالك وسمعتها أكتر من مرة؟",
    "لو وصفت ريحة أول لقاء لينا، تفتكر كانت ريحة إيه؟ (مطر، برفان معين، ورد؟)",
    "إيه أكتر خصلة في طبعي خلتك تقول 'هي دي اللي هتشاركني حياتي'؟",
    "تفتكر إيه أكتر حاجة كانت بتهون عليك وقتك الصعب وأنت بعيد عني؟",
    "إيه أكتر هدية بسيطة جبتها لك ولسه شايلها في مكان غالي عندك؟",
    "فاكر أول مرة عيطنا فيها سوا؟ تفتكر إيه اللي كان مأثر فينا وقتها؟",
    "إيه هي الكلمة اللي كنت بقولها لك زمان وبتحسسسك إنك ملك العالم؟",
    "لو قدرت توصف أول 'نظرة عين' بينا بكلمة واحدة، هتكون إيه؟",
    "إيه الموقف اللي خلاني في نظرك مش بس حبيبة، لكن 'أهل ووطن'؟",
    "تفتكر إيه أكتر سر حكيتهولي زمان وكنت خايف من رد فعلي؟",
    "إيه أكتر حاجة كنت بتعملها 'عشاني' من ورايا وأنا عرفتها بالصدفة؟",
    "لو رجع الزمان، تفتكر كنت هتختارني تاني في نفس الظروف؟",
    "إيه هو المكان اللي كل ما بنعدي من قدامه قلبك بيفرح كأننا لسه في البداية؟",
    "فاكر أول مرة اختلفنا فيها وصالحنا بعض بكلمة 'بحبك'؟",
    "إيه هو الدعاء اللي كنت دايماً بتدعيه عشاني وعشان علاقتنا؟",
    "لو كتبت قصة حبنا في كتاب، تفتكر إيه هيكون عنوان أول فصل؟",
    "إيه أكتر حاجة في ملامحي اتغيرت من يوم ما عرفتني وبتحبها أكتر دلوقتي؟",

    // === قسم "روح اللي جاي" (25 سؤال خيال ورومانسية مستقبلية) ===
    "لو صحينا بكره لقينا نفسنا في مكان مجهول، إيه الحاجة الوحيدة اللي هتحتاج تاخدها معاك غيري؟",
    "نفسك نحتفل بعيد جوازنا الـ 50 فين وإزاي؟",
    "لو قدرت تختار 'حلم واحد' نكمله سوا السنة دي، هيكون إيه؟",
    "لو وصفتني لواحد غريب مشافنيش قبل كده، هتقول عني إيه عشان يحبني؟",
    "إيه أكتر حاجة نفسك نعملها سوا لأول مرة لما نتقابل المرة دي؟",
    "لو خيروك تعيش عمرك كله في 'لحظة واحدة' عشناها سوا، تختار أنهي لحظة؟",
    "نفسك بيتنا المستقبلي يكون فيه 'ركن' خاص بينا إحنا بس.. تفتكر هيكون شكله إيه؟",
    "لو وصفت حبنا بلون، تفتكر هيكون أنهي لون وليه؟",
    "إيه الحاجة اللي نفسي تعملها لي المرة دي من غير ما أطلبها منك؟",
    "لو بقينا عواجيز وقاعدين على كرسي هزاز، تفتكر هنكون بنحكي عن إيه؟",
    "لو طلبت منك توعدني وعد واحد للمستقبل، هيكون إيه؟",
    "تفتكر إيه أكتر حاجة هتفضل 'ثابتة' في حبنا مهما الزمن غيرنا؟",
    "لو نقدر نسافر بالزمن، تحب نشوف أولادنا وهما كبار ولا نرجع نشوف أهلنا وهما شباب؟",
    "إيه هي الأغنية اللي نفسي تغنيها لي بصوتك حتى لو مش بتعرف تغني؟",
    "لو بقيت 'ملاك حارس' ليا ليوم واحد، إيه أكتر حاجة هتحميني منها؟",
    "نفسك نتصور صورة 'مجنونة' فين المرة دي؟",
    "لو وصفت إحساسك وأنت راجع لي في الطيارة بكلمة واحدة، هتكون إيه؟",
    "إيه أكتر حاجة في شخصيتي بتخليك تحس إن الدنيا لسه بخير؟",
    "لو خيروك تختار لي 'لقب' رومانسي جديد يناديك بيه بيننا بس، هيكون إيه؟",
    "نفسك نتعلم 'هواية' جديدة سوا لما ترجع؟ زي إيه؟",
    "لو فيه قصيدة شعر مكتوبة عننا، تفتكر أول بيت فيها هيكون إيه؟",
    "إيه هو الشيء اللي بتمناه لبيتنا ولحياتنا ومخبيينه في سرنا؟",
    "لو تقدر تشيل من قاموسنا 'كلمة' واحدة بتزعلنا، تختار كلمة إيه؟",
    "تفتكر إيه أكتر حاجة بتخليني فخورة بيك كزوج وشريك حياة؟",
    "لو كان حبنا 'لوحة'، تفتكر مين اللي هيرسمها وإيه هيكون شكلها؟"
/*        // === قسم زمان (25 سؤال ذكريات) ===
    ...
    questions: [
        ...
        { text: "وضعية الخلفي (Doggy Style): تركع المرأة على يديها وركبتيها ويدخل الرجل من الخلف. يتيح هذا الوضع إيلاجاً عميقاً وإثارة قوية.", img: "Images/Image2.jpg" },
        { text: "وضعية الملعقة (Spooning): يستلقي الشريكان على جانبيهما في نفس الاتجاه. وضعية مريحة جداً وتسمح بالتقارب الجسدي واللمسات الرقيقة.", img: "Images/Image3.jpg" },
        { text: "وضعية الفارسة (Cowgirl Position): تجلس المرأة فوق الرجل وهو مستلقٍ على ظهره. يمنح هذا الوضع المرأة التحكم الكامل في السرعة والعمق.", img: "Images/Image4.jpg" },
        { text: "وضعية الجلوس (Sitting Position): يجلس الرجل على كرسي أو حافة السرير وتجلس المرأة في حضنه. تسمح بتبادل القبلات والاحتضان بسهولة.", img: "Images/Image7.jpg" },
        { text: "وضعية المقص (Scissors Position): يستلقي الشريكان وجهاً لوجه مع تشابك أرجلهما مثل المقص. توفر اتصالاً جسدياً وثيقاً وزوايا إثارة فريدة.", img: "Images/Image6.jpg" },
        { text: "وضعية الفراشة (Butterfly Position): تستلقي المرأة على حافة السرير مع رفع ساقيها، بينما يقف الرجل أمامها. توفر عمقاً كبيراً في الإيلاج.", img: "Images/Image8.jpg" },
        { text: "وضعية الوقوف (Standing Position): يقف الشريكان وجهاً لوجه. تتطلب هذه الوضعية بعض القوة البدنية وتضيف حيوية وتغييراً للروتين.", img: "Images/Image9.jpg" },
        ...
        { text: "وضعية الفارسة العكسية (Reverse Cowgirl Position): يستلقي الرجل وتجلس المرأة فوقه بظهرها نحوه للتحكم الكامل في الإيقاع.", img: "Images/Image18.jpg" },
