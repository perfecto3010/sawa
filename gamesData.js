...
heat_meter: {
    ...
    "إيه أول انطباع حقيقي خدته عني أول ما شوفتني؟ (من غير تجميل 😉)",
    "متى بدأت تحس إن المشاعر اللي بيننا قلبت 'حب حقيقي' مش مجرد إعجاب؟",
    "إيه أكتر حاجة في شكلي لفتت نظرك في أول مقابلة؟",
    "لو رجع بينا الزمن ليوم الخطوبة.. إيه أكتر ذكرى لسه محفورة في قلبك؟",
    "إيه هو 'السر' اللي كنت مخبيه عني في بداية علاقتنا وقولتهولي بعد الجواز؟",
    "تفتكر إيه هي أفضل وأسوأ عادة شوفتها فيا أول ما عشنا تحت سقف واحد؟",
    "إيه الموقف اللي حصل قبل جوازنا وكنت بتتمنى وقتها لو كنت أنا جنبك؟",
    "لو وصفت زواجنا في 3 كلمات بس.. هتختار إيه؟",
    "إيه أكتر تصرف 'متهور' أو 'جريء' عملته في حياتك قبل ما تعرفني؟",
    "فاكر أول مرة اختلفنا فيها؟ مين فينا اللي بدأ يصالح التاني وقتها؟",
    "إيه هي الأغنية اللي أول ما بتسمعها بتقول 'دي أغنيتنا'؟",
    "لو كتبنا قصتنا في رواية.. تفتكر إيه العنوان اللي يليق علينا؟",
    "إيه الحاجة اللي كانت صعبة في الجواز ومكنتش متخيل إنها هتكون كدة؟",
    "إيه الصفة اللي اكتسبتها مني أو حاجة اتعلمتها بسببي؟",
    "فاكر أكتر موقف مضحك أو محرج حصل لنا سوا في مكان عام؟",
    "إيه الكلمة اللي كنت دايماً بتقولها لي زمان ودلوقتي وحشاك تسمعها؟",
    "لو خيروك ترجع تعيش يوم واحد بس من الماضي معانا.. تختار أنهي يوم؟",
    "إيه أكتر هدية بسيطة مني لسه محتفظ بيها وبتحبها؟",
    "مين أول حد من صحابك عرف إنك 'وقعت' في حبي؟ وقال لك إيه؟",
    "إيه هو أكتر موقف حسيت فيه إنك 'محظوظ' بجد إنك اتجوزتني؟",
    "إيه هي أكتر صفة في شخصيتي كانت بتجذبك ليا في فترة التعارف؟",
    "لو رجعنا لأول صورة اتصورناها سوا.. تفتكر كنا حاسين بإيه وقتها؟",
    "إيه الحاجة اللي كنت بتخاف منها في بداية علاقتنا ودلوقتي بتضحك عليها؟",
    "إيه أكتر أكلة أكلناها سوا وليها ذكرى مضحكة معانا؟",
    "لو وصفت 'أول لمسة إيد' بينا.. كان إحساسك إيه؟",

    // === قسم "روح اللي جاي" (25 سؤال خيال وصراحة مستقبلية) ===
    "لو حصلت معجزة وبدلنا أجسادنا ليوم واحد.. إيه أول حاجة هتعملها بجسمي؟",
    "كيف تتخيل شكل حياتنا لما نكبر ونبقى 'عواجيز' قاعدين سوا؟",
    "لو تقدر تختار صفة واحدة مني تطلع في أولادنا.. تختار إيه؟",
    "لو خيّرتك بين إنك تسمع صوتي بس (مكالمات) أو تشوفني بس (صور) من غير صوت.. تختار إيه؟",
    "إيه الصفة اللي تتمنى إنها تفضل موجودة فيا للأبد وما تتغيرش؟",
    "لو كسبنا مليون جنيه دلوقتي.. إيه أول خروجة هنخرجها؟",
    "تفتكر إحنا محتاجين نتعلم 'مهارة' إيه سوا عشان حياتنا تبقى أحلى؟",
    "لو كنا شخصيات في مسلسل كرتون.. تفتكر مين فينا 'توم' ومين 'جيري'؟",
    "إيه هو الشيء اللي بتدعي ربنا دايماً إنه يحفظه لنا ويديمه في علاقتنا؟",
    "لو صحيت لقيت نفسك بتعرف تقرأ أفكاري لمدة ساعة.. إيه أول حاجة هتدور عليها؟",
    "لو تقدر تشتري لي أي حاجة في العالم دلوقتي حالاً.. هتجيب لي إيه؟",
    "نفسك نسافر بلد إيه نقضي فيها شهر لوحدنا تماماً؟",
    "لو تقدر تغير حاجة واحدة بس في 'روتيننا اليومي'.. هتكون إيه؟",
    "إيه أكتر حاجة في شخصيتي بتخليك تحس بالأمان؟",
    "لو عملنا قناة يوتيوب عن حياتنا.. تفتكر الناس هتحب فينا إيه أكتر حاجة؟",
    "لو تقدر 'تستلف' موهبة واحدة مني لمدة يوم.. تختار إيه؟ (زي الطبخ، الصبر، إلخ)",
    "إيه الحاجة اللي نفسي تعملها لي المرة دي لما تيجى من غير ما أطلبها؟",
    "لو وصفت حبنا 'بلون'.. تفتكر هيكون إيه؟",
    "نفسك نتعلم هواية جديدة سوا لما ترجع؟ زي إيه؟",
    "لو معاك 'ريموت كنترول' للحياة.. تحب تعمل 'Pause' على أنهي لحظة بنعيشها؟",
    "إيه أكتر حاجة بتخليك فخور بيا كشريك حياتك قدام الناس؟",
    "لو تقدر تختار لي 'اسم شهرة' جديد بيني وبينك بس.. هيكون إيه؟",
    "إيه الأكلة اللي لو طبختها لك كل يوم مش هتزهق منها أبداً؟",
    "لو تقدر تشيل 'كلمة' واحدة من قاموس خناقاتنا.. تختار كلمة إيه؟",
    "قول لي سر لأول مرة تعرفهولي.. وأنا كمان هقولك سر عندي! 🤫"
